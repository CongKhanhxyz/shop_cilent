            ...
            <div class="general-info">
                ...
                <div class="block-info-2 box-shadow">
                    <div>
                        ...
                        <input class="input-general" id="product-name" name="productName"/>
                        <span class="error-label"></span>
                    </div>
                    <div>
                        <label for="shortDescription" class="label-color bold-title">Mô tả ngắn</label>
                        <input class="input-general" id="shortDescription" name="shortDescription"/>
            ...
            <div class="sale-info">
                ...
                <div class="block-info-2 box-shadow">
                    ...
                    <div>
                        ...
                        <input onkeyup="format()" type="text" value = "0" class="input-general" id="oldPrice" name="oldPrice"
                    ...
                    <div>
                        ...
                        <input type="number" class="input-general" id="quantity" name="quantity" value="0"
                               onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'"/>
                        <span class="error-label"></span>
                    </div>
                    <div>
                        <label for="percent" class="label-color bold-title">% Giảm giá</label>
                        <input class="input-general" id="percent" style="margin-bottom: 6px;" name="percentDiscount"/>
                        <span class="error-label"></span>
                    </div>
                    <div>
                        <label for="newPrice" class="label-color bold-title">Giá mới</label>
                        <input class="input-general" id="newPrice" style="margin-bottom: 6px;" name="newPrice"/>
                        <span class="error-label"></span>
                    </div>
                </div>
            </div>
